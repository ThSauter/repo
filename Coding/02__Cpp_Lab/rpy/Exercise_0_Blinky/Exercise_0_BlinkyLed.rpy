...
{ IProject 
	...
	- _myState = 8192;
	- _name = "Exercise_0_BlinkyLed";
	- _modifiedTimeWeak = 4.3.2017::20:28:13;
	- _lastID = 1;
	...
	- Diagrams = { IRPYRawContainer 
		...
		{ IDiagram 
			...
			- _lastModifiedTime = "3.29.2017::8:39:48";
...
<frame name=OperationListCompartment>";
		...
		{ IDiagram 
			...
			- _name = "Runtime";
			- _modifiedTimeWeak = 1.2.1990::0:0:0;
			- _lastModifiedTime = "3.29.2017::8:41:28";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIObjectInstance 
					...
					- m_drawBehavior = 2824;
					- m_transform = 0.0982059 0 0 0.123886 54.8036 26.2415 ;
					- m_bIsPreferencesInitialized = 0;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIObjectInstance 
					- _id = GUID 16c07296-98a2-45bc-96d7-b52203636bf6;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 2;
							- value = 
					...
					- m_pModelObject = { IHandle 
						...
						- _class = "TopLevel";
						- _name = "itsLed_1";
						- _id = GUID f11415e6-f68d-452b-affe-50d1e357bf18;
					}
					- m_pParent = GUID b52cdc03-c2b6-4488-853b-f4506fa80109;
					- m_name = { CGIText 
						- m_str = "itsLed_1:Led";
					...
					- m_drawBehavior = 2824;
					- m_transform = 0.0982059 0 0 0.123886 204.804 26.2415 ;
					- m_bIsPreferencesInitialized = 0;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
					- Compartments = { IRPYRawContainer 
						...
						- value = 
						{ CGICompartment 
							- _id = GUID 475af554-dbd4-4f5d-8978-67aa3d2750c1;
							- m_name = "Attribute";
							- m_displayOption = Public;
							- m_bShowInherited = 0;
							- m_bOrdered = 0;
						...
						{ CGICompartment 
							- _id = GUID 72daccf1-5108-40de-a2cf-4ae4f27c234a;
							- m_name = "Operation";
							- m_displayOption = Public;
							- m_bShowInherited = 0;
							- m_bOrdered = 0;
