...
{ IProject 
	...
	- _myState = 8192;
	- _name = "Exercise_3_LedWithPoti";
	- _modifiedTimeWeak = 4.3.2017::19:19:41;
	- _lastID = 1;
...
<frame name=OperationListCompartment>";
		...
		{ IDiagram 
			...
			- _name = "Runtime";
			- _modifiedTimeWeak = 1.2.1990::0:0:0;
			- _lastModifiedTime = "3.29.2017::14:23:49";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIObjectInstance 
					...
					- m_drawBehavior = 2824;
					- m_transform = 0.183192 0 0 0.144385 54.6336 19.4973 ;
					- m_bIsPreferencesInitialized = 0;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
