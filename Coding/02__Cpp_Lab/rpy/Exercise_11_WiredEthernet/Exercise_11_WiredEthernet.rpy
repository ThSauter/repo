...
{ IProject 
	...
	- _modifiedTimeWeak = 4.30.2017::12:20:15;
	...
	- Diagrams = { IRPYRawContainer 
		...
		{ IDiagram 
			...
			- _lastModifiedTime = "1.24.2013::9:34:35";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIClass 
					...
					- Compartments = { IRPYRawContainer 
						...
						- value = 
						{ CGICompartment 
							- _id = GUID 929d49e1-e5e7-4d3a-b410-78abf648f549;
							- m_name = "Attribute";
						...
						{ CGICompartment 
							- _id = GUID a9ecd291-fb44-42b3-8f55-11366a6efd98;
							- m_name = "Operation";
							- m_displayOption = Explicit;
							- m_bShowInherited = 0;
							- m_bOrdered = 0;
				...
				{ CGIPackage 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.425164 0 0 0.308427 189 52.3311 ;
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.419768 0 0 0.381442 114.41 32.1331 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIClass 
					...
					- m_pModelObject = { IHandle 
						...
						- _subsystem = "ExamplePkg";
						- _class = "";
						- _name = "SequentialController";
						- _id = GUID 85cc7090-8ea9-41aa-a79b-d49f655e74fc;
					}
					- m_pParent = GUID 54de6680-07b1-4904-b4da-2e7da0db3111;
					- m_name = { CGIText 
						- m_str = "SequentialController";
						- m_style = "Arial" 10 0 0 0 1 ;
						- m_color = { IColor 
							- m_fgColor = 0;
							- m_bgColor = 0;
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.419768 0 0 0.381442 676.545 32.3026 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.186563 0 0 0.329427 526.482 581.145 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
