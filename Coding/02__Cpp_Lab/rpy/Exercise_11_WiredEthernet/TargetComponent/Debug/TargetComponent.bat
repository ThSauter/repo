...
rem ## $Id: WST_RXF_V6.prp 35025 2016-08-09 11:42:33Z eroemer $
rem ## $URL: https://svn.willert.de/V6/trunk/Component/Modelling/Rpy/Config/UserSettings/WST_RXF_V6.prp $
rem ##

set WST_JAVA_PATH="C:\Program Files (x86)\IBM\Rational\Rhapsody\8.1.4\jdk\jre\bin"
set WST_RELEASE_PATH=C:\Users\Hochschule Ulm\Willert\Rpy_CPP_CMSIS_Keil5_ARM_MCB1700_TD_V6.01
...
@%MYECHO% Preparing header files for environment Rpy_CPP_CMSIS_Keil5_ARM_MCB1700_TD_V6_01...

set TARGET_TYPE=Executable
set TARGET_NAME=TargetComponent
set BUILDSET=Debug
...
%WST_JAVA_PATH%"\java" -jar "%WST_RELEASE_TOOLS%/CheckModified.jar" TargetComponent.bat RxfDimensions.h
if errorlevel == 1	 			call :RxfDimensions
        
%WST_JAVA_PATH%"\java" -jar "%WST_RELEASE_TOOLS%/CheckModified.jar" TargetComponent.bat RxfConstants.h
if errorlevel == 1				call :RxfConstants


call :DeployerFileLists


%WST_JAVA_PATH%"\java" -jar "%WST_RELEASE_TOOLS%/CheckModified.jar" TargetComponent.bat WSTMemoryTypes.h
if errorlevel == 1	 			call :WSTMemoryTypes  
...
if exist WSTMemoryTypes.h  	 		del WSTMemoryTypes.h 
exit /B
...
%MYECHO% -------
rem -------------------------------------------------------------------------------------------------------
rem IMPORTANT NOTE REGARDING MEMORY SECTION MECHANISM:
rem -------------------------------------------------------------------------------------------------------
rem The RXF allows to generate WSTMemoryTypes.h with the compiler pragmas needed to define named sections.
rem To enable this mechanism, please install gnu awk and make it available in your PATH environment and
rem remove the "rem" comment-statements in the following three lines while adding "rem" to the default line
rem which creates an empty WSTMemoryTypes.h file to speed up compilation.
rem -------------------------------------------------------------------------------------------------------
rem if not exist "WSTMemoryTypeMacro.template" copy "%WST_RELEASE_MEMSECTIONS%\WSTMemoryTypeMacro.template" WSTMemoryTypeMacro.template
rem if not exist "WSTMemoryTypePragmas.txt" copy "%WST_RELEASE_MEMSECTIONS%\WSTMemoryTypePragmas.txt" WSTMemoryTypePragmas.txt
rem awk.exe -f "%WST_RELEASE_TOOLS%\macroAndPragma2Header.awk" pragmaFile=WSTMemoryTypePragmas.txt useShortSectionNames=0 WSTMemoryTypeMacro.template > WSTMemoryTypes.h
%MYECHO% /* Empty memory section allocation file to speed up compilation. Please see MakefileContent property for details. */ > WSTMemoryTypes.h
exit /B
...
%MYECHO% -------
%MYECHO% /* This file is generated by TargetComponent.bat; do not edit! */					>  RxfDimensions.h
...
%MYECHO% ---------
%MYECHO% /* This file is generated by TargetComponent.bat via Rhapsody; do not edit! */		>  RxfConstants.h
%MYECHO% -@D@ %RPY_COMPILE_SWITCHES%														>> RxfConstants.h
%MYECHO% -@D@ 												>> RxfConstants.h
%MYECHO% -@D@ -DWST_ANIMATION -DWST_LIVE_ANIMATION -DWST_TARGET_DEBUGGING_ENABLED 													>> RxfConstants.h
%MYECHO% -@D@ 													>> RxfConstants.h
