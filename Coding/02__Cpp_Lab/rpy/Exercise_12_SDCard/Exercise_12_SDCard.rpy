...
{ IProject 
	...
	- _modifiedTimeWeak = 6.1.2017::13:44:45;
	- _lastID = 2;
	...
	- Diagrams = { IRPYRawContainer 
		...
		{ IDiagram 
			...
			- _lastModifiedTime = "6.1.2017::13:44:45";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIPackage 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.771381 0 0 0.439617 10 1.79533 ;
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4200;
					- m_transform = 0.164617 0 0 0.18182 24.4168 750.996 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.164617 0 0 0.18182 341.868 787.498 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIAssociationEnd 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 1048 896 ;
					- m_TargetPort = 348 695 ;
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.164036 0 0 0.181958 24.911 257.03 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.164617 0 0 0.18182 352.629 250.653 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIAssociationEnd 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 496 1357 ;
					- m_TargetPort = 561 329 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "";
					}
					- m_pInstance = { IObjectLinkHandle 
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.164617 0 0 0.18182 819.657 257.095 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIObjectInstance 
					...
					- m_drawBehavior = 2824;
					- m_transform = 0.168083 0 0 0.0374332 991.66 135.684 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIObjectInstance 
					...
					- m_drawBehavior = 2824;
					- m_transform = 0.168083 0 0 0.0374332 991.66 188.684 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIInheritance 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 730 1278 ;
					- m_TargetPort = 14 756 ;
					- m_ShowName = 0;
					- m_ShowStereotype = 1;
				}
				{ CGIAssociationEnd 
					- _id = GUID 79ea7814-8288-47fe-9666-7f2a25c24dc9;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pModelObject = { IHandle 
						...
						- _class = "Joystick";
						- _name = "itsLedBar";
						- _id = GUID 952cd400-be7d-4e34-bf41-fcb7aaec204a;
					}
					- m_pParent = ;
					- m_name = { CGIText 
						- m_str = "";
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 891 1096 ;
					- m_TargetPort = 79 1132 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "";
					}
					- m_pInstance = { IObjectLinkHandle 
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.1321 0 0 0.218184 607.735 17.5069 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIAssociationEnd 
					- _id = GUID d27b80a2-f280-4f0b-a62b-353272dd73f9;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pModelObject = { IHandle 
						...
						- _class = "Joystick";
						- _name = "itsSDCard";
						- _id = GUID e9d29e93-7ce2-46d5-9da0-fdb30cb62ff4;
					}
					- m_pParent = ;
					- m_name = { CGIText 
						- m_str = "";
					...
					- m_arrow = 2 253 154  253 112  ;
					- m_anglePoint1 = 0 0 ;
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 733 494 ;
					- m_TargetPort = 83 1067 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "";
					}
					- m_pInstance = { IObjectLinkHandle 
				...
				{ CGIAssociationEnd 
					- _id = GUID c33dd89a-613c-46aa-a12f-46981892776f;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pModelObject = { IHandle 
						...
						- _class = "SDCard";
						- _name = "itsDisplay";
						- _id = GUID ce546efb-874b-4ee2-92c7-4682e44fd85e;
					}
					- m_pParent = ;
					- m_name = { CGIText 
						- m_str = "";
					...
					- m_arrow = 2 617 89  617 188  ;
					- m_anglePoint1 = 0 0 ;
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 548 831 ;
					- m_TargetPort = 290 920 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "";
					}
					- m_pInstance = { IObjectLinkHandle 
				...
				{ CGIClass 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.0853569 0 0 0.124403 620.742 834.694 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=OperationListCompartment>";
				...
				{ CGIAssociationEnd 
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 453 1294 ;
					- m_TargetPort = 549 481 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "";
					}
					- m_pInstance = { IObjectLinkHandle 
