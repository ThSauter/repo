...
public :
    ...
    //## auto_generated
    int getJoystickPos() const;
    
    //## auto_generated
    void setJoystickPos(int p_joystickPos);
...
protected :
    ...
    int joystickPos;		//## attribute joystickPos
...
public :
    ...
    // pauseLedBar:
    //## statechart_method
    inline bool pauseLedBar_IN() const;
...
inline bool Board::pauseLedBar_IN() const {
    return state_3_subState == pauseLedBar;
}
