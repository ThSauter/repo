/**
 * Monitor interface implementation for ARM-Cortex devices with the ITM interface.
 ...
 *
 * $Id: WSTMonitorIO_Keil_CortexM3_ITM.c 35905 2016-11-15 12:56:46Z mspieker $
...
void WSTMonitorIO_receiveIncomingData( void ){
	if(ITM_RxBuffer != 0x5AA55AA5){	//if the default value has changed new data is availeble from the ITM-Viewer...
		monitorNbCmd = WSTTRUE;	/* set a flag that the monitore is able to recive a command */
	}
}
