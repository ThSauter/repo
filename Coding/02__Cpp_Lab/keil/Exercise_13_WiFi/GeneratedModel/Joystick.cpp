...
void Joystick::sample() {
    ...
    {
    	lastPosition = position;    	
    	FIRE( this->itsUartTransmitter, evNewJoystickPosition(position));
    } 
...
UartTransmitter* Joystick::getItsUartTransmitter() const {
    return itsUartTransmitter;
}

void Joystick::setItsUartTransmitter(UartTransmitter* p_UartTransmitter) {
    itsUartTransmitter = p_UartTransmitter;
}
