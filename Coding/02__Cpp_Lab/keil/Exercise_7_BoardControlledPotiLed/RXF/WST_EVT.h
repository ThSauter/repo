...
// 
// $Id: WST_EVT.h 33001 2015-10-01 11:33:51Z mspieker $
...
public :
	...
	WSTBoolean toBeCancelled(WST_FSM* destination, const WST_EVT_ID_t id);
	...
	//## auto_generated
	WST_INLINE_OP WST_EVT* getNext( void ) { return next; }
	
	//## auto_generated
	WST_INLINE_OP void setNext(WST_EVT* p_event) { next = p_event; }
