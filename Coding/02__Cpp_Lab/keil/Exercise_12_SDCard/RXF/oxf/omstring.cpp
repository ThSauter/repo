...
//static const char* rcsid = "//! $Id: omstring.cpp 32759 2015-07-25 11:27:59Z mspieker $";
//#endif
//#]
...
void OMString::setSize(int newSize) {
    ...
    str = (char*)WST_MEM::getMemory( size );
    //lint -restore
    //#]
}
