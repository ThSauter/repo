...
rem  $Id: WSTDeployer.bat 35033 2016-08-10 13:32:15Z czoeller $
...
rem               =============================================================
SET WST_JAVA_PATH="@RPYPROG_1@\jdk\jre\bin"
rem               =============================================================
...
echo Deployer arguments from Rhapsody: %1 %2 %3 %4 %5 %6 >WSTDeployerCallLog.txt
...
rem No post deploy cmd specified for this environment
