...
********************************************************************************
@file       GLCD.h
@brief      Graphic LCD function prototypes and defines.
            Erweiterte Version fuer RTX-Betriebssystem 
            
@details    Erweiterung der GLCD-Version aus Keil uVision 4.71.
            Mutex-Schutz der oeffentlichen Methoden bei Multitasking.
...
/*------------------------------------------------------------------------------
  Color coding
  GLCD is coded:   
  15..11 red, 10..5 green, 4..0 blue (unsigned short) GLCD_R5, GLCD_G6, GLCD_B5   
  original coding: 
  17..12 red, 11..6 green, 5..0 blue                   ORG_R6,  ORG_G6,  ORG_B6
...
extern void GLCD_DrawChar       (unsigned int x,  unsigned int y, unsigned int cw, 
...
extern void GLCD_PrintChar      ( unsigned char c ); // hinzugefuegt Normann

extern void GLCD_Bargraph       (unsigned int x,  unsigned int y, 
                                 unsigned int w, unsigned int h, unsigned int val);
extern void GLCD_Bitmap         (unsigned int x,  unsigned int y, unsigned int w, 
